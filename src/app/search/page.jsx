    ...
    <div className=' bg-black'>
      ...
      <nav className="flex items-center p-3 absolute top-0 left-0 w-full h-16 bg-transparent z-50 mt-3">
        ...
        <div className="flex items-center mr-8 w-[80%]">
          ...
          <div
            className={` w-[90%] transition-all duration-700 ease-in-out flex items-center ${
          ...
          {!isSearching && (
            <button
              ...
              className="flex items-center justify-center w-12 h-12 rounded-lg bg-gray-800 hover:bg-gray-700"
            >
